...
export class Account extends React.Component {
  constructor(props) {
    super(props);
    this.state = {saldo: 0, current: 0, confirmed: "(unconfirmed)", setSelected: false, selected: false};
  }
    ...
    return (
      <div className="Account-container">
        ...
        <ButtonGroup fullWidth aria-label="full width secondary contained button group">
          ...
          <Button onClick={this.confirm.bind(this)}>Repeat</Button>
          <Button onClick={this.confirm.bind(this)}>Clear</Button>
        </ButtonGroup>
      </Grid>
